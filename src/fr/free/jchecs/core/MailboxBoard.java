...
/**
 * Représentation d'un état de la partie basée sur un tableau bordé à une
 * dimension pour stocker les positions.
 * <p>
 ...
 * @author David Cotton
 */
public class MailboxBoard extends AbstractMoveGenerator {
    ...
    /**
     * Liste des modificateurs pour les mouvements d'un cavalier dans la
     * mailbox.
     */
     ...
     */
    final Piece[] _pieces = new Piece[FILE_COUNT * RANK_COUNT];
     ...
     * @param pSuivant Drapeau positionné si l'on souhaite que le trait soit
     * modifié.
        ...
        for (int i = FILE_COUNT * RANK_COUNT; --i >= 0; /* Pré-décrémenté */) {
            ...
            if ((p != null) && (p.isWhite() == pTrait)) {
                ...
                for (final Square dst : getValidTargets(orig)) {
                    ...
                    //termina na linha acima, onde é criado um novo Move corresponde
                    // e valido para a peca obtida
