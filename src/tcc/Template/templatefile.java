...
public class templatefile {
    ...
    static void assignMainScriptFile(Pod pod, String filename)
            throws RbxGhostException {
        System.out.println("Assigning main script. Name: " + filename);

        // Assign script
        
        try {
            int seqNum = pod.assignMainScriptFromFile(filename);
            waitForPodCmdFinished(pod, seqNum);
    ...
    //C:\Users\Anderson\Google Drive\TCC_Drive\Pratica\Robix\partePratica\algorithms\Robix1\src\movs.txt
    static String nameFile(String name){
        return  System.getProperty("user.dir") + "/src/" + name;
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(MAIN_SCRIPT);
...
//         Sensor sensor = pod.getSensor(1);
            ///// Assign script /////
            //from file
            assignMainScriptFile(pod, "C:\\Users\\Anderson\\Google Drive\\TCC_Drive\\Pratica\\Robix\\partePratica\\movsRobix\\mapeamento.rbxScript");
            //assign method add
//            assignMainScript(pod, "macro teste\n up_init;\n square;\n end\n", MAIN_SCRIPT_NAME);
