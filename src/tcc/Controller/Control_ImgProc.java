...
public class Control_ImgProc implements Runnable {
    ...
    /**
    * Neste local vc irá colocar a classe que obtem as strings de Move.
    * Se vc tiver que usar mais de uma, crie como eu fiz.
    *   Criei uma classe chama BridgeToRobix, que seria ponte entre a classe Robix e a controller,
    *   onde eu só uso um metodo para retornar o que desejo.
    * 
    * No seu caso seria um metodo que tira as fotos e retorna somente uma strMoveFromImgs
    *
    *private ClasseImgProc nomeClasse
    */
    ...
    /**
     * Loop que espera a jogada do Robix para poder tirar novas fotos.
     *      Caso vc ja faça isso, ignore.
     *      Pq coloquei essa condição para ficar mais pratica as conversas dos controllers
     * 
     */
    ...
    public void run() {
        while (true) {            
            ...
            if (takePictures) {
                /**
                 * Nesse local que vc irá receber a string das operações das imgs.
                 * 
                 * Estou utilizando o metodo stringsDoTeclado, como forma de testes. 
                 */
                String moveFromImg = stringsDoTeclado();
                
                /**
                 * Se a String recebida estiver válida, iremos setar a variavel StrMoveImg
                 * E liberar a operacao para o Tabuleiro ser atualizado.
                 */
